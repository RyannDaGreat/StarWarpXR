 ...
 * Sandbox atmosphere/material functions retained from upstream.
 */
...
@fragment fn fs(in: VsOut) -> FsOut {
    ...
    // invViewProj is the inverse GL matrix: depth -1=near, 1=far.
    let nearClip  = vec4f(in.clipXY, -1.0, 1.0);
...
@vertex fn vs(in: VsIn) -> VsOut {
    ...
    // Convert only raster depth GL [-w,w] → WebGPU [0,w]; flow keeps GL XY/W.
    out.position    = vec4f(out.currClip.xy, (out.currClip.z + out.currClip.w) * 0.5, out.currClip.w);
    return out;
}
